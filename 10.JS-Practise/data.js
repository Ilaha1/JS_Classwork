...
// let topTenPopilation=countries_data.sort((a,b)=>b.population-a.population).slice(0,10);
// console.log(topTenPopilation);

//ingilis dilli ölkeleri

// const foundEnlish = countries_data.filter((item) => item.languages.includes("English" ))
// console.log(foundEnlish);

//region asia ve europe olanlar

// const foundRegion = countries_data.filter((item) => item.region==="Asia" || item.region==="Europe" )
...
// console.log(countries_data.reduce((acc,curr,i,arr)=>acc+curr.population,0));
